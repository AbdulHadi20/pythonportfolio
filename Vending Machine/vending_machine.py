...
# Dictionaries of snacks and drinks

item_1 = {'Item Code': 0, 'Item Price': 1.50, 'Item Name': 'Lays (salted)'}
item_2 = {'Item Code': 1, 'Item Price': 2.50, 'Item Name': 'Doritos (BBQ)'}
item_3 = {'Item Code': 2, 'Item Price': 3.50,
          'Item Name': 'Cheetos (flaminhot)'}
item_4 = {'Item Code': 3, 'Item Price': 1.50, 'Item Name': 'Chips-Oman'}
item_5 = {'Item Code': 4, 'Item Price': 2.00, 'Item Name': 'Croissant'}
item_6 = {'Item Code': 5, 'Item Price': 3.00, 'Item Name': 'Cupcakes'}
item_7 = {'Item Code': 6, 'Item Price': 2.00, 'Item Name': 'kitkat'}
item_8 = {'Item Code': 7, 'Item Price': 2.50, 'Item Name': 'Snickers'}
item_9 = {'Item Code': 8, 'Item Price': 2.50, 'Item Name': 'Mars'}
item_10 = {'Item Code': 9, 'Item Price': 2.50, 'Item Name': 'Bounty'}
item_11 = {'Item Code': 10, 'Item Price': 2.50, 'Item Name': 'Galaxy'}
item_12 = {'Item Code': 11, 'Item Price': 2.00, 'Item Name': 'MilkyWay'}
item_13 = {'Item Code': 12, 'Item Price': 1.50, 'Item Name': 'Mango Juice'}
item_14 = {'Item Code': 13, 'Item Price': 1.50, 'Item Name': 'Apple Juice'}
item_15 = {'Item Code': 14, 'Item Price': 1.50, 'Item Name': 'Orange Juice'}
item_16 = {'Item Code': 15, 'Item Price': 2.00, 'Item Name': 'Mix-Fruit Juice'}
...
item_20 = {'Item Code': 19, 'Item Price': 2.50, 'Item Name': 'Mango Milkshake'}
item_21 = {'Item Code': 20, 'Item Price': 2.50,
           'Item Name': 'Banana Milkshake'}
item_22 = {'Item Code': 21, 'Item Price': 4.00, 'Item Name': 'Pepsi'}
item_23 = {'Item Code': 22, 'Item Price': 4.00, 'Item Name': 'Mountain Dew'}
item_24 = {'Item Code': 23, 'Item Price': 4.00, 'Item Name': '7 UP'}
item_25 = {'Item Code': 24, 'Item Price': 4.00, 'Item Name': 'Fanta'}
item_26 = {'Item Code': 25, 'Item Price': 1.50, 'Item Name': 'Tea (karak)'}
item_27 = {'Item Code': 26, 'Item Price': 1.00, 'Item Name': 'Water (small)'}
item_28 = {'Item Code': 27, 'Item Price': 2.00, 'Item Name': 'Water(large)'}
...
def menu():
    ...
    print('\n \t \t ..........SNACKS.......... ')
    print('\n ITEM CODE \t \t ITEM PRICE \t \t ITEM NAME')
    for i in items[0:6]:
        print(
            f"      {i['Item Code']} \t \t   $ {i['Item Price']} \t \t  {i['Item Name']}")
...
# function that manages money and make sure that correct amount is payed and correct change is given if any
